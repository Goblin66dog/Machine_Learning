...
#创建对象
        result_old = SVC_Classifier(image_old, label_old, mode = mode)
        result_new = SVC_Classifier(image_new, label_new, mode = mode)
# 类别,投影信息
...
# 颜色分类
        ...
        result_old = result_old.train_svc()
        result_new = result_new.train_svc()
# 行列号
...
# 图例
        ...
        plt.savefig(result_path + "\\" + "change_detection_SVC.png", dpi=300)
        SVC_Classifier.image_writer(project, transform, re_class, result_path + "\\" + "change_detection_SVC.tif")
if __name__ == "__main__":
    SVC_Classifier.change_detection(
